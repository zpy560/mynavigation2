...
def generate_launch_description():
    ...
    launch_file_dir = os.path.join(get_package_share_directory('turtlebot3_test'), 'launch')

    ign_resource_path = SetEnvironmentVariable(
        name='IGN_GAZEBO_RESOURCE_PATH',value=[
        os.path.join("/opt/ros/humble", "share"),
        ":" +
        os.path.join(get_package_share_directory('turtlebot3_test'), "models")])
    ...
    ignition_spawn_entity = Node(
        ...
        arguments=['-entity', TURTLEBOT3_MODEL,
                   ...
                   '-file', PathJoinSubstitution([
                        get_package_share_directory('turtlebot3_test'),
    ...
    world_only = os.path.join(get_package_share_directory('turtlebot3_test'), "models", "worlds", "world_only.sdf")
